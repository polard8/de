...
static int __browser_registered = FALSE;
...
{
// Let's register a browser to give it access to he display.
...
//
    ...
    {
        // #debug
        gwssrv_debug_print ("registerBrowser: [FAIL] __p_cgroup\n");
        printf             ("registerBrowser: [FAIL] __p_cgroup\n");
        exit(1);
...
//
    ...
    {
        // #debug
        gwssrv_debug_print ("registerBrowser: [FAIL] __pid\n");
        printf             ("registerBrowser: [FAIL] __pid\n");
        exit(1);
